...
// SECURITY NOTE: This frontend-only password gate is not secure; anyone can view the source.
// For real security, use a backend auth provider such as Firebase or Supabase.
...
const DEFAULT_REVIEWS = [
  {
    ...
    questions: [
      {
        questionText: "Which quantity is a vector?",
        choices: ["Speed", "Distance", "Velocity", "Time"],
        correctIndex: 2
      },
      {
        questionText: "What unit is used for acceleration?",
        choices: ["m/s", "m/s²", "N", "kg"],
        correctIndex: 1
      },
      {
        questionText: "A car travels 30 m in 5 s. Its average speed is:",
        choices: ["5 m/s", "6 m/s", "25 m/s", "150 m/s"],
        correctIndex: 1
      }
    ]
  },
  {
    ...
    questions: [
      {
        questionText: "Which unit is used for power?",
        choices: ["Joule", "Watt", "Newton", "Pascal"],
        correctIndex: 1
      },
      {
        questionText: "Work is calculated as:",
        choices: ["Force × Distance", "Mass × Velocity", "Voltage × Resistance", "Pressure × Area"],
        correctIndex: 0
      },
      {
        questionText: "In a neutral atom, the number of protons equals the number of:",
        choices: ["Neutrons", "Electrons", "Ions", "Nuclei"],
        correctIndex: 1
      }
    ]
  },
  {
    ...
    questions: [
      ...
      {
        questionText: "The atomic number tells you the number of:",
        choices: ["Neutrons", "Protons", "Electrons + Protons", "Isotopes"],
        correctIndex: 1
      }
    ]
  },
  {
    ...
    questions: [
      ...
      {
        questionText: "A base typically has a pH:",
        choices: ["Less than 7", "Greater than 7", "Equal to 7", "Exactly 1"],
        correctIndex: 1
      },
      {
        questionText: "Which indicator turns pink in a basic solution?",
        choices: ["Litmus", "Phenolphthalein", "Bromothymol blue", "Methyl orange"],
        correctIndex: 1
      }
    ]
  }
